  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-green-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Contribute Card - Full Width */}
        <div className="w-full max-w-6xl mx-auto">
          <div className="bg-white/80 backdrop-blur-lg shadow-2xl rounded-2xl overflow-hidden border border-gray-200">
            <div className="grid md:grid-cols-2 min-h-[700px]">
              
              {/* Left Side - Decorative */}
              <div className="hidden md:flex flex-col justify-center items-center bg-gradient-to-br from-blue-500 via-blue-400 to-indigo-400 text-white p-12 relative overflow-hidden">
